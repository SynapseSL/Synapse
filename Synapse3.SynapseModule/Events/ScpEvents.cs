...
public class ScpEvents : Service
{
    ...
    public readonly EventReactor<Scp096ObserveEvent> Scp096Observed = new();
    public readonly EventReactor<Scp173AttackEvent> Scp173Attack = new();
    public readonly EventReactor<Scp173ObserveEvent> Scp173Observed = new();
    ...
    public override void Enable()
    {
        ...
        _eventManager.RegisterEvent(Scp096Observed);
        _eventManager.RegisterEvent(Scp173Attack);
        _eventManager.RegisterEvent(Scp173Observed);
    ...
    public override void Disable()
    {
        ...
        _eventManager.UnregisterEvent(Scp096Observed);
        _eventManager.UnregisterEvent(Scp173Attack);
        _eventManager.UnregisterEvent(Scp173Observed);
...
{
    public Scp173ActivateBreakneckSpeedEvent(SynapsePlayer scp173)
    {
        Scp173 = scp173;
    }
...
public class Scp106ContainEvent : PlayerInteractEvent
{
    public Scp106ContainEvent(SynapsePlayer player) : base(player, true) { }
}

public class Scp106CreatePortalEvent : IEvent
{
    public Scp106CreatePortalEvent(SynapsePlayer scp106, Vector3 position)
    {
        Scp106 = scp106;
        Position = position;
    }
