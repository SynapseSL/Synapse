...
namespace Synapse.Config
{
    public class ConfigHandler
    {
        ...
        internal void Init()
        {
            ...
            _ = SynapseTranslation.AddTranslation(new Synapse.Translation.Translation(), "ENGLISH");
            _ = SynapseTranslation.AddTranslation(new Translation.Translation
            {
