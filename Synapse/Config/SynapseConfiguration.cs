...
namespace Synapse.Config
{
    ...
    {
        #region Hosting
        [Description("If you enable this Feature only Players with the Synapse Client can join your Server.\n# This will activate a bunch of Features like Loading Prefabs\n# WARNING: This Value can't be changed by a reload you have to restart the Server")]
        public bool SynapseServerList { get; set; } = false;
